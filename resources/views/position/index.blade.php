                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="search_description" name="search_description" value="{{ request('search_description') }}">
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
            ...
            <table class="table nowrap border display" id="mytable" style="width:100%">
                ...
                <tbody>
                    @foreach($table as $position)
                        <tr>
                            <td>
                                <a href="{{ route('position.edit', $position->position_code) }}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                <form action="{{ route('position.destroy', $position->position_code) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
